...
exports.getProfile = exports.forgotPassword = exports.googleLogin = exports.login = exports.register = void 0;
...
const googleLogin = async (req, res) => {
    try {
        ...
        if (!user) {
            const mockPasswordHash = await bcryptjs_1.default.hash(Math.random().toString(36).substring(7), 10);
